...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        [SerializeField] public AudioSource SmokeSound;
        [System.Serializable]
        ...
        IEnumerator Hit()
        {
            ...
            SmokeEffect.Play();
            SmokeSound.Play();
            GameObject.Find("KartClassic_MLAgent").GetComponent<ArcadeKart>().baseStats.TopSpeed = 0.1f;
            yield return new WaitForSeconds(8);
            GameObject.Find("KartClassic_MLAgent").GetComponent<ArcadeKart>().baseStats.TopSpeed = 15;
            SmokeEffect.Stop();
            yield return new WaitForSeconds(0);
        }
    }
